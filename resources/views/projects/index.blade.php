                    ...
                    @foreach ($projects as $project)
                        <tr class="hover:bg-gray-200 hover:text-black transition">
                            ...
                            <td class="py-2 px-4 border-b border-gray-700 whitespace-nowrap text-center">
                                <a href="{{ route('projects.edit', $project->id) }}"  class="text-blue-400 hover:text-blue-600 font-semibold mr-4 transition">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <a href="{{ route('projects.finalize', $project->id) }}"class=" text-green-500 hover:text-green-700  font-semibold mr-4 transition">
