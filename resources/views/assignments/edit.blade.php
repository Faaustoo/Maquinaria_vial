<x-app-layout>
    <div class="max-w-xl mx-auto p-2">
        <form action="{{ route('assignments.update', $assignment->id) }}" method="POST" class="bg-white dark:bg-gray-800 p-4 rounded shadow">
            @csrf
            @method('PUT')
            ...
            <div class="mb-3">
                <label for="machine_id" class="block text-gray-700 dark:text-gray-200 mb-1 text-sm font-semibold">Máquina</label>
                <select 
                    name="machine_id" 
                    id="machine_id" 
                    class="w-full border border-gray-300 dark:border-gray-600 rounded p-1.5 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm"
            ...
            <div class="mb-3">
                <label for="project_id" class="block text-gray-700 dark:text-gray-200 mb-1 text-sm font-semibold">Proyecto</label>
                <select 
                    name="project_id" 
                    id="project_id" 
                    class="w-full border border-gray-300 dark:border-gray-600 rounded p-1.5 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm"
