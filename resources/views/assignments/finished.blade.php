<x-app-layout>
    <div class="py-6 max-w-7xl mx-auto sm:px-6 lg:px-8 text-white">
        ...
        <div class="mb-4">
            <a href="{{ route('assignments.index') }}" class="inline-block px-4 py-2 bg-gray-600 text-white font-semibold rounded hover:bg-gray-700 transition">← Volver a Asignaciones Activas</a>
        </div>
                ...
                <tbody>
                    @forelse ($assignments as $assignment)
                        <tr class="hover:bg-gray-200 hover:text-black transition">
                            ...
                            <td class="py-2 px-4 border-b border-gray-700">{{ \Carbon\Carbon::parse($assignment->end_date)->format('d/m/Y') }}</td>
