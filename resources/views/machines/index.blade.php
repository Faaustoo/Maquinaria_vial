<x-app-layout>
    <div class="py-6 max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="bg-yellow  dark:bg-gray-800 p-6 rounded shadow">
            <h3 class="text-lg font-semibold text-center text-white">Maquinas registradas</h3>
            
                <table class="min-w-full mt-4 table-auto">
                    <thead>
                        <tr class="bg-gray-100 dark:bg-gray-700">
                            <th class="py-2 px-4 border-b text-left text-white">Numero de serie</th>
                            <th class="py-2 px-4 border-b text-left text-white">Modelo</th>
                            <th class="py-2 px-4 border-b text-left text-white">Tipo de Maquina</th>
