<x-app-layout>
    <div class="max-w-xl mx-auto p-2">
        <form action="{{ route('machines.store') }}" method="POST" class="bg-yellow dark:bg-gray-800 p-4 rounded shadow">
            ...
            <div class="mb-3">
                <label for="serial_number" class="block text-white font-semibold mb-1 text-sm">Numero de Serie</label>
                <input type="text" name="serial_number" id="serial_number" class="w-full bg-gray-900 text-white border border-gray-600 rounded p-1.5 focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="ABC-####" 
                    value="{{ old('serial_number') }}">
            </div>

            <div class="mb-3">
                <label for="model" class="block text-white font-semibold mb-1 text-sm">Modelo</label>
                <input type="text" name="model" id="model" class="w-full bg-gray-900 text-white border border-gray-600 rounded p-1.5 focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Modelo-####" 
                    value="{{ old('model') }}">
            </div>

            <div class="mb-3">
                <label for="kilometers" class="block text-white font-semibold mb-1 text-sm">Kilometros</label>
                <input type="number" name="kilometers" id="kilometers" class="w-full bg-gray-900 text-white border border-gray-600 rounded p-1.5 focus:outline-none focus:ring-2 focus:ring-blue-500" 
            ...
            <div class="mb-3">
                <label for="type_id" class="block text-white font-semibold mb-1 text-sm">Maquina</label>
                <select name="type_id" id="type_id" class="w-full bg-gray-900 text-white border border-gray-600 rounded p-1.5 focus:outline-none focus:ring-2 focus:ring-blue-500">
                    <option value="" disabled {{ old('type_id') ? '' : 'selected' }}>Seleccionar tipo de maquina</option>
